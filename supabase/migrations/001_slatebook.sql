...
create table if not exists public.form_fields (
  ...
  field_type text not null check (field_type in ('text', 'textarea', 'number', 'date', 'expiry', 'email', 'phone', 'card', 'cvv', 'select')),
...
-- The workspace is intentionally limited to its single seeded Lead intake form.
-- Form metadata is managed by the migration/function, not by the browser.
